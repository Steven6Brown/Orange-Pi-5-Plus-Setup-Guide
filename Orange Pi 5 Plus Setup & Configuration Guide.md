...
<body>
    <div class="cover-page">
        <div>
            <h1>Digital Cloak</h1>
            <h2>Orange Pi 5 Plus Setup & Configuration Guide</h2>
            <img src="images/DigitalCloakLogo.png" alt="Company Logo">
            <p><strong>Report Issued: 07/12/2024</strong></p>
        </div>
    </div>
</body>
</html>
...
![eMMC Module Top](images/eMMCModuleTop.png)
![eMMC Module Bottom](images/eMMCModuleBottom.png)
...
![eMMC Module Location Diagram](images/eMMCLocation.png)
...
![Heat Sinks Location Diagram](images/HeatSinksLocation.png)
![Heat Sinks Device Diagram](images/HeatSinks.png)
...
![WiFi Card](images/WiFiCard.png)
![WiFi Card Location Diagram](images/WiFiLocationDiagram.png)
...
![990 NVME 2TB Storage](images/NVME.png)
![990 NVME 2TB Storage Location Diagram](images/NVMELocationDiagram.png)
...
![Orange Pi 5 Plus Motherboard Case Mounting Diagram](images/CaseMount.png)
...
![Fan Plugin Diagram](images/FanPluginDiagram.png)
![Fan Plugin Location](images/FanPluginLocations.png)
...
![Fan Plugged In](images/FanPluggedIn.png)
...
![SD Card Slot](images/SDCardSlot.png)
...
![PoE Splitter](images/PoESplitter.png)
...
![Type-C Power](images/Type-CPower.png)
...
![Ethernet Port Plugin](images/EthernetPlugin.png)
...
#### Log Into The Central Kimset Server
...
![Kismet Setup 1](images/KismetSetupStep1(1).png)
...
![Kismet Setup 2](images/KismetSetupStep1(2).png)
...
![Kismet Setup 3](images/KismetSetupStep1(3).png)
